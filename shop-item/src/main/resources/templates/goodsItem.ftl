...
<head>
    ...
    <script type="text/javascript" src="http://localhost/shop-resources/js/topPage.js"> </script>
...
<div class="top">
    <div class="top-con w1200">
        <p class="t-con-l f-l" id="showUser"></p>
...
<div class="hd-info1 w1200">
    <div class="logo f-l">
        <h1><a href="http://localhost/shop-home" title="中林网站"><img src="images/logo.jpg" /></a></h1>
    </div>
    ...
    <div class="deta-info1">
        <div class="dt-if1-l f-l">
            <div class="dt-if1-datu">
                <ul qie-da="">
                    <#list gpicList as gpic>
                        <li><a href="#"><img style="width:359px;height: 351px"  src="${gpic}" /></a></li>
                    </#list>
                    <div style="clear:both;"></div>
                </ul>
            </div>
            <div class="dt-if1-qietu">
                ...
                <div class="dt-qie-con f-l">
                    <ul qie-xiao="">
                        ...
                        <#list gpicList as gpic>
                            <#if (gpic_index == 0)>
                                <li class="current"><a href="#"><img style="width:60px;height: 60px" src="${gpic}" /></a></li>
                            <#else>
                                <li><a href="#"><img style="width:60px;height: 60px" src="${gpic}" /></a></li>
                            </#if>
                        </#list>
                        <div style="clear:both;"></div>
                    </ul>
        ...
        <div class="dt-if1-m f-l">
            ...
            <dl class="dt-ifm-box3">
                ...
                <dd>
                    ...
                    <input type="text" id="g-sum" value="1">
            ...
            <div class="dt-ifm-box4">
                ...
                <button class="btn2" onclick="addCar()">加入购物车</button>
...
<script type="text/javascript">
    function addCar(){
        ...
        // 3.发送请求
        utils.ajax({
            url:"http://localhost/shop-car/car/addCar",
            data:param,
